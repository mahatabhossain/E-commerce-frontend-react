...
const Profile = () => {
    ...
    const handleSelectProfileImage = async (e) => {
        ...
        const userProfileImage = await axios.post(`${process.env.REACT_APP_ENDPOINT}/upload/profile/image/`,
            ...
            <div className="account_section_continer">
                ...
                <div className="h-full flex sm:flex-row flex-col items-center sm:justify-start justify-center text-center sm:text-left">
                    ...
                    <div className="flex-grow sm:pl-8">
                        ...
                        {!editProfile.updateEmail ? <h3 className="text-gray-500 mb-3 flex"> <span>{profileData.email}</span> &nbsp; < BorderColorIcon onClick={() => handleEditValue('updateEmail', 'email')} /></h3>
                ...
                <div className='address_container'>
                    {address.length > 0 ? <h2>Add another address &nbsp;<Button
                        onClick={() => { addAddress() }}
